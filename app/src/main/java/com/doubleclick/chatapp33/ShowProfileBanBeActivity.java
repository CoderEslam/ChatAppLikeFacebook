...
public class ShowProfileBanBeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNhantin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ShowProfileBanBeActivity.this, ChatActivity.class);
    ...
    private void HuyketBan() {
        new AlertDialog.Builder(ShowProfileBanBeActivity.this).setTitle("Bạn Muốn Hủy Bạn Bè").setPositiveButton("Đồng Ý", new DialogInterface.OnClickListener() {
            @Override
        ...
        mUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    Toast.makeText(ShowProfileBanBeActivity.this, "Du lieu ko ton tai ", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ShowProfileBanBeActivity.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}